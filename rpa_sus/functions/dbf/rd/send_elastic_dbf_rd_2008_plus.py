...
def prepare_es_doc(record, index_name, fields_to_include=COLUNS_TO_WATCH_2008_plus):
                ...
                body={
                    ...
                    "mappings": {
                        "properties": {
                            ...
                            "CNES": {"type": "keyword"}, 
                            "CNPJ_MANT" : {"type": "keyword"}, #2008
                            "COMPLEX": {"type": "keyword"}, #2008
                            "FINANC": {"type": "keyword"}, #2008
                            "FAEC_TP": {"type": "keyword"}, #2008
