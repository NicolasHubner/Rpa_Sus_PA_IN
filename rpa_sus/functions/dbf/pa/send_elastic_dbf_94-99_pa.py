...
from configs.constants import CARATEND_CODES, state_codes, FINANC_CODES, FAECTP_CODES
...
initial_path = '/home/nicolas/FreeLancers/FlavioProject/rpa_sus/data/DBFs'

dbf_directory = initial_path
